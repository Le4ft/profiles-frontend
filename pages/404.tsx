...
export default function Custom404() {
    ...
    marginTop='-15px'
     ...
     >
      ...
      <Heading size="md" textTransform="uppercase" fontFamily="Josefin Sans">Page doesn't exist</Heading>
      We're sorry, but this page doesn't exist. Check your link if you think this was a mistake.</Text>
      <Link
      color="white"

...
export default function ShortenC({ Profile }) {
    ...
    marginTop='-15px'
     ...
     >
      ...
      <Heading size="md" textTransform="uppercase" fontFamily="Josefin Sans" >Profile Disabled</Heading>
      We're sorry, but you can't see this profile because user disabled their profile.</Text>
      <Link
      color="white"
